...
const TemplateWrapper = (props) => {
  return (
    <StaticQuery
      render={(data) => {
        const frontmatter = props.data && props.data.markdownRemark ? props.data.markdownRemark.frontmatter : null
          ...
          <div>
            <Helmet
              ...
              meta={[
                ...
                {
                  name: 'description',
                  content: frontmatter ? frontmatter.description : data.site.siteMetadata.description
                },
                {
                  name: 'og:description',
                  content: frontmatter ? frontmatter.description : data.site.siteMetadata.description
            ...
            <div className="navbar navbar-light gradient">
              ...
              {!frontmatter ? null : <h2>{`${frontmatter.section} – ${frontmatter.title}`}</h2>}
            </div>
